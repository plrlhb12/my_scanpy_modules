...
def annotate_2(adata, new_cluster_names, key=None, out=None, project=None, figure_type=None):
    """
...
def main():
    ...
    if new_cluster_names:
        annotate_2(adata, new_cluster_names, key=key, out=out, project=project, figure_type=figure_type)
    else:
