...
def setup(dpi=None, figsize=None):
    """
...
figure_type=None,min_genes=None, min_cells=None, n_genes_by_counts=None, pct_counts_mt=None):
    """
...
def normalize_regress(adata, show=None, project=None, figure_type=None, exclude_highly_expressed=None):
    """
...
def pca(adata, color_gene=None, show=None, project=None, figure_type=None, out=None):
...
def main():
    parser = argparse.ArgumentParser(description="Arguments for scRNA-seq QC")
    # basic parameters
    ...
    parser.add_argument("-o", "--out", type=str, help="the file name prefix of the output anndata", default="count_after_QC")
